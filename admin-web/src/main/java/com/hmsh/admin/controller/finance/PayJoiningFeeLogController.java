...
import com.hmsh.app.vo.order.PayJoiningFeeLog;
 ...
 */
@Controller
@RequestMapping("/pjflog")
public class PayJoiningFeeLogController extends BaseController<PayJoiningFeeLog,Long> {

	@Override
	public BaseFacadeService<PayJoiningFeeLog, Long> getService() {
	...
	public ModelAndView index(HttpServletRequest request, HttpSession session) {
		ModelAndView mv = new ModelAndView("finance/pjflog");
		return mv;
	}

	/*private static final Logger log = LoggerFactory.getLogger(PayJoiningFeeAction.class);
	...
	*//**
	...
	public ModelAndView index() {
		...
		mv.setViewName("finance/payJoiningFeeLog/index");
		return mv;
	}
